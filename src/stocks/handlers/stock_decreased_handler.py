...
from stocks.commands.write_stock import update_stock_redis
...
class StockDecreasedHandler(EventHandler):
    ...
    def handle(self, event_data: Dict[str, Any]) -> None:
        ...
        try:
            update_stock_redis(event_data.get('order_items', []), '-')
        except Exception as redis_error:
            self.logger.debug(f"Echec de mise à jour du cache Redis : {redis_error}")
